...
def robot_sense(robot, msg):
    ...
    if 'UP' in msg[1]:
        ...
        for i in range(2, 5):
            if robot.face == 'W':
                if x+i in range(15) and mdp_map[x+i][y].text == 'W':
                    mdp_map[x+i][y].has_image = True
                    mdp_map[x+i][y].imgdir = 'A'
                    imgstr = str(x+i) + ';' + str(y) + ';' + 'A'
                    print(imgstr)
            elif robot.face == 'A':
                if y+i in range(20) and mdp_map[x][y+i].text == 'W':
                    mdp_map[x][y+i].has_image = True
                    mdp_map[x][y+i].imgdir = 'S'
                    imgstr = str(x) + ';' + str(y+i) + ';' + 'S'
                    print(imgstr)
            elif robot.face == 'S':
                if x-i in range(15) and mdp_map[x-i][y].text == 'W':
                    mdp_map[x-i][y].has_image = True
                    mdp_map[x-i][y].imgdir = 'D'
                    imgstr = str(x-i) + ';' + str(y) + ';' + 'D'
                    print(imgstr)
            elif robot.face == 'D':
                if y-i in range(20) and mdp_map[x][y-i].text == 'W':
                    mdp_map[x][y-i].has_image = True
                    mdp_map[x][y-i].imgdir = 'W'
...
##        print(steps)
        ...
        steps += 1
        if robot.coord[0] > 10 and robot.coord[1] > 16 and robot.face != 'D' and not goal_explored and not turned:
            print('NEAR GOAL')
            robot_right(robot)
            right_wall_before = False
            turned = True
