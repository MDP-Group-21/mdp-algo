        ...
        if eye[0]+2 in range(15) and mdp_map[eye[1]][eye[0]].fpath != 'D':
            ...
            if not wflag and mdp_map[eye[1]][eye[0]+2].explored:
                if mdp_map[eye[1]][eye[0]+1].fpath == '1':
                    ...
                    if mdp_map[eye[1]][eye[0]+1].fpath == mdp_map[eye[1]][eye[0]].fpath:
                        frontier.append(Frontier([eye[0]+1,eye[1]], step_eval(eye[0]+1,eye[1],end), h_eval(eye[0]+1,eye[1],begin)))
                    else:
                        frontier.append(Frontier([eye[0]+1,eye[1]], step_eval(eye[0]+1,eye[1],end)+2, h_eval(eye[0]+1,eye[1],begin)))
                    #print('D, frontier')
            wflag = False
        ...
        if eye[1]+2 in range(20) and mdp_map[eye[1]][eye[0]].fpath != 'W':
            ...
            if not wflag and mdp_map[eye[1]+2][eye[0]].explored:
                if mdp_map[eye[1]+1][eye[0]].fpath == '1':
                    ...
                    if mdp_map[eye[1]+1][eye[0]].fpath == mdp_map[eye[1]][eye[0]].fpath:
                        frontier.append(Frontier([eye[0],eye[1]+1], step_eval(eye[0],eye[1]+1,end), h_eval(eye[0],eye[1]+1,begin)))
                    else:
                        frontier.append(Frontier([eye[0],eye[1]+1], step_eval(eye[0],eye[1]+1,end)+2, h_eval(eye[0],eye[1]+1,begin)))
