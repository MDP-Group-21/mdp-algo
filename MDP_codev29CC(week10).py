...
def robot_cornered(robot):
    ...
    if robot.face == 'W':
        if x+2 not in range(15) and y+2 not in range(20):
            return True
        elif mdp_map[y-1][x+2].text == 'W' and mdp_map[y][x+2].text == 'W' and mdp_map[y+1][x+2].text == 'W' and mdp_map[y+2][x-1].text == 'W' and mdp_map[y+2][x].text == 'W' and mdp_map[y+2][x+1].text == 'W':
            return True
    elif robot.face == 'A':
        if x-2 not in range(15) and y+2 not in range(20):
            return True
            ...
            if not wflag and mdp_map[eye[1]+2][eye[0]].explored:
                if mdp_map[eye[1]+1][eye[0]].fpath == '1':
                    ...
                    if mdp_map[eye[1]+1][eye[0]].fpath == mdp_map[eye[1]][eye[0]].fpath:
                        ...
                        frontier.append(Frontier([eye[0],eye[1]+1], step_eval(eye[0],eye[1]+1,end)+2, h_eval(eye[0]-1,eye[1],begin)))
