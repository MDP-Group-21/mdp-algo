...
class Robot(object):
    def __init__(self, coord, face, wall_left=False, wall_right=False, wall_ahead=False, second_ahead=False, movetwo = False):
        self.coord = coord
        self.face = face
